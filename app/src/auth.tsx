...
// an account is purely an optional local profile until server accounts launch
// with Cloud Backup billing (see company/business-model.md). Passwords are
// stored as SHA-256 hashes, never plaintext. There is no server yet —
